...
COLUMNA_C_NUEVA = {
    "1. Discovery e Insights":
        "META-CAPACIDAD: Estrategia de investigación: componer objetivo, enfoque, metodología y "
        "técnicas de forma coherente con la decisión que se necesita tomar.\n\n"
        "OBJETIVO: Problem framing (de decisión de negocio a pregunta de investigación y conducta "
        ...
        "METODOLOGÍA: Desk research (evidencia secundaria); investigación en campo / etnográfica; "
        "estudios longitudinales y de seguimiento.\n\n"
        "TÉCNICA: Recolección: entrevistas, observación estructurada, diarios, encuestas, intercept y "
        "mystery shopping (campo físico), analítica de comportamiento. Análisis: diseño muestral, "
        "codificación, triangulación de métodos y fuentes, síntesis.\n\n"
        "MARCO: Frameworks de ciencias del comportamiento para leer conducta (COM-B, EAST); "
        "systems thinking.\n\n"
        "ARTEFACTO: Insight; plan y estrategia de investigación.\n\n"
        "CALIDAD Y ÉTICA: Calidad y suficiencia de la evidencia; gestión de sesgos; límites de "
        "validez; consentimiento y privacidad.\n\n"
        "COMPETENCIAS: Pensamiento crítico.",

    "2. Estrategia y Problem Solving":
        "META-CAPACIDAD: Juicio estratégico: decidir qué problema merece resolverse y con cuánta "
        "evidencia basta para decidirlo, haciendo explícito el riesgo de equivocarse.\n\n"
        "OBJETIVO: Problem reframing; opportunity framing; formulación y priorización de hipótesis "
        "estratégicas; definición de direcciones y de trade-offs.\n\n"
        "ENFOQUE: Integración de la evidencia de usuario, de comportamiento y de negocio; lectura "
        "divergente para abrir alternativas y convergente para cerrar la decisión; evidencia "
        "primaria, secundaria y de mercado.\n\n"
        "METODOLOGÍA: Síntesis estratégica sobre evidencia acumulada; análisis del espacio de "
        "problema y de oportunidades; análisis de escenarios; modelado de sistemas y de actores.\n\n"
        "TÉCNICA: Encuadre: árboles de problema, reformulación de la pregunta, mapas de oportunidad. "
        "Decisión: matrices de priorización, evaluación de valor, viabilidad, riesgo y esfuerzo, "
        "análisis de trade-offs, pre-mortem.\n\n"
        "MARCO: Frameworks de Research, Design y Behavioral Science (COM-B, EAST, MINDSPACE); "
        "systems thinking; teoría del cambio; modelos de negocio y de valor.\n\n"
        "ARTEFACTO: Problema reencuadrado; mapa de oportunidades; hipótesis priorizadas; narrativa "
        "estratégica de la decisión.\n\n"
        "CALIDAD Y ÉTICA: Supuestos explícitos y trazables; estándar de evidencia exigible según el "
        "tipo de decisión; declaración del riesgo de equivocarse; ética de la intervención "
        "propuesta.\n\n"
        "COMPETENCIAS: Pensamiento crítico; business acumen; storytelling estratégico.",

    "3. Diseño y Orquestación de Experiencias":
        "META-CAPACIDAD: Criterio de intervención: decidir cuánta intervención pide una conducta, "
        "elegir la palanca proporcional al problema y al riesgo ético, y reconocer cuándo lo "
        "correcto es no intervenir.\n\n"
        "OBJETIVO: Traducir evidencia y estrategia en principios, conceptos e intervenciones; "
        "modificar una conducta objetivo; orquestar la experiencia a través de touchpoints y "
        "canales.\n\n"
        "ENFOQUE: Diseño conductual, única especialidad de diseño de la matriz. Se diseña sobre "
        "conducta observada y no sobre conducta declarada; intervención puntual frente a sistema de "
        "intervenciones; reducir fricción frente a añadir refuerzo.\n\n"
        "METODOLOGÍA: Diseño de intervenciones conductuales; arquitectura de decisiones aplicada a "
        "un journey; ciclos iterativos de concepto, prueba y ajuste; co-diseño con las áreas dueñas "
        "de la experiencia.\n\n"
        "TÉCNICA: Palancas: fricción y esfuerzo, defaults, timing y saliencia, framing y "
        "comunicación conductual, incentivos, normas sociales, personalización. Proceso: traducción "
        "de insights a criterios de diseño, ideación y conceptualización, prototipado conceptual, "
        "behavioral walkthrough, diseño de contenido conductual.\n\n"
        "MARCO: Arquitectura de decisiones; journey thinking; systems thinking; taxonomías de "
        "palancas y de sesgos.\n\n"
        "ARTEFACTO: Principios y criterios de diseño; concepto de intervención; prototipo "
        "conceptual; blueprint de orquestación; hipótesis conductual lista para validar.\n\n"
        "CALIDAD Y ÉTICA: Ética de la influencia — transparencia, autonomía de la persona, no "
        "explotación de sesgos, reversibilidad de la intervención; proporcionalidad entre el "
        "problema y la palanca; testeabilidad; equidad del efecto entre segmentos.\n\n"
        "COMPETENCIAS: Pensamiento crítico aplicado al propio diseño; comunicación visual y "
        "narrativa del concepto; escucha y traducción entre disciplinas.",

    "4. Experimentación, Medición e Impacto":
        "META-CAPACIDAD: Criterio de evidencia: decidir cuánto rigor exige cada decisión y cuánto "
        "sería desperdiciarlo, ajustando el diseño al costo, al riesgo y a la reversibilidad.\n\n"
        "OBJETIVO: UX validation (concepto, prototipo, experiencia); evaluación del efecto de las "
        "intervenciones conductuales; evaluación de impacto; decisión de iterar, escalar o "
        "detener.\n\n"
        "ENFOQUE: Observacional frente a experimental; cuantitativo, cualitativo de validación y "
        "mixto; medición en condiciones controladas frente a medición en condiciones reales.\n\n"
        "METODOLOGÍA: Diseño experimental; RCT; cuasi-experimentos por sede, territorio o cohorte; "
        "pre-post con grupo de control; pruebas de concepto y de prototipo; piloto en campo (físico) "
        "y en producto (digital).\n\n"
        "TÉCNICA: Diseño: operacionalización de hipótesis y variables, definición de grupos y regla "
        "de asignación, cálculo de tamaño muestral. Ejecución y análisis: A/B testing y "
        "multivariante, concept & prototype testing, usability testing, analytics e instrumentación, "
        "análisis estadístico y por segmentos.\n\n"
        "MARCO: Inferencia causal; teoría del cambio; jerarquía de evidencia; modelo lógico de la "
        "intervención (el mecanismo por el que se espera que funcione).\n\n"
        "ARTEFACTO: Hipótesis operacionalizada; métricas y criterios de éxito definidos antes de "
        "medir; lectura de resultados con tamaño de efecto; recomendación de decisión.\n\n"
        "CALIDAD Y ÉTICA: Validez interna y externa; control de variables; potencia y tamaño "
        "muestral; triangulación como criterio de robustez; ética experimental — consentimiento, uso "
        "de grupos de control, reversibilidad y no daño al grupo no expuesto.\n\n"
        "COMPETENCIAS: Honestidad intelectual ante resultados negativos; comunicación de la "
        "incertidumbre; rigor en la lectura de datos ajenos.",

    "5. Escalamiento y Liderazgo":
        "META-CAPACIDAD: Criterio de escalamiento y liderazgo: decidir qué se estandariza, qué se "
        "deja variar y a qué ritmo se le puede exigir a un equipo, sosteniendo el equilibrio entre "
        "lo que el equipo produce y lo que el equipo puede sostener.\n\n"
        "OBJETIVO: Escalar conocimiento, prácticas y capacidades; desarrollar personas; sostener una "
        "cultura de decisión basada en evidencia.\n\n"
        "ENFOQUE: Evidencia acumulativa frente a estudio aislado; estandarizar frente a dejar "
        "variar; construir capacidad interna frente a resolver por encargo.\n\n"
        "METODOLOGÍA: ResearchOps, BehavioralOps y KnowledgeOps como sistemas de trabajo; gobernanza "
        "de estándares y de datos; capability building y modelos de desarrollo de personas; mejora "
        "continua.\n\n"
        "TÉCNICA: Conocimiento: repositorios y taxonomías de evidencia, activación y democratización "
        "del conocimiento, automatización de tareas operativas, trazabilidad. Liderazgo y equipo: "
        "feedback ascendente anónimo, observación estructurada de reuniones (habla, interrupciones y "
        "atribución de ideas), registro de asignación de oportunidades visibles, planes de "
        "desarrollo, entrevista de salida.\n\n"
        "MARCO: Systems thinking aplicado a la propia capacidad; modelo de madurez de la práctica; "
        "ciclo de mejora continua; el propio marco conductual aplicado al equipo — la conducta de "
        "quien lidera también es conducta observable.\n\n"
        "ARTEFACTO: Estándares y playbooks; repositorio de evidencia; catálogo de intervenciones "
        "reutilizables; modelo de capacidades del Council; tablero del equilibrio "
        "productividad–satisfacción del equipo.\n\n"
        "CALIDAD Y ÉTICA: Estándares metodológicos; gobernanza de datos, privacidad y trazabilidad; "
        "gestión de calidad. Ética del liderazgo, en dos partes que no se mezclan. EQUILIBRIO (se "
        "pondera): productividad del equipo ↔ satisfacción del equipo con la persona que lidera, "
        "leídas en el mismo periodo y nunca por separado. UMBRAL (se verifica, no se pondera): "
        "respeto básico, sin acoso, sin mansplaining, sin conductas excluyentes; su incumplimiento "
        "verificado bloquea el nivel y no entra en la ponderación.\n\n"
        "COMPETENCIAS: Stakeholder management; influencia; comunicación estratégica; facilitación; "
...
BLOQUES_LEEME = [
    ...
    ("Criterio de ordenamiento aplicado a cada celda",
     "Las cinco dimensiones usan la MISMA estructura de nueve campos, siempre en este orden y sin "
     "excepciones:\n"
     "  META-CAPACIDAD → OBJETIVO → ENFOQUE → METODOLOGÍA → TÉCNICA → MARCO → ARTEFACTO → "
     "CALIDAD Y ÉTICA → COMPETENCIAS\n"
     "Que la estructura sea idéntica es lo que hace comparables las cinco dimensiones entre sí: si "
     "un campo estuviera en unas y no en otras, la comparación volvería a depender de cómo esté "
     "redactada cada celda.\n"
     "Dos integraciones para no romper la estructura: las palancas conductuales de D3 viven dentro "
     "de TÉCNICA (son el instrumento de la intervención), y ResearchOps, BehavioralOps y "
     "KnowledgeOps de D5 viven dentro de METODOLOGÍA (son la forma de estructurar el trabajo, no un "
     "instrumento suelto)."),
