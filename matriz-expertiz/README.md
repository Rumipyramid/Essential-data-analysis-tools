...
| 1. Taxonomías | Diccionario: 9 clases de capacidad (T1–T9), 3 ejes transversales (E1–E3), 2 categorías de control (X, Y). |
| 2. Ejes transversales | Campos de investigación (incluye la respuesta a «¿alguna más?»), sujetos y especialidad de diseño. |
| 3. Desglose capacidades | Los ítems actuales de la columna, uno por fila, con clase, nombre normalizado y decisión. |
...
| 6. Hallazgos y decisiones | Problemas detectados y preguntas abiertas para cerrar con los dos leads. |
...
```
META-CAPACIDAD → T1 Objetivo → T2 Enfoque → T3 Metodología → T4 Técnica
